...
@section('content')
        ...
        <div class="advantages">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    ...
                    <div class="icon-text"><p>УДОБНОЕ</p>
                        <p>РАСПИСАНИЕ</p></div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <img src="{{ url('/site_images/icon-check.png') }}">
                    <div class="icon-text"><p>ДОСТУПНО</p>
                        <p>КАЖДОМУ</p></div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <img src="{{ url('/site_images/icon-video.png') }}">
                    <div class="icon-text"><p>ЛУЧШИЕ</p>
                        <p>ВИДЕОУРОКИ</p></div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <img src="{{ url('/site_images/icon-dialog.png') }}">
                    <div class="icon-text"><p>ИНДИВИДУАЛЬНЫЕ</p>
                        <p>КОНСУЛЬТАЦИИ</p></div>
                </div>
    ...
    <div class="container">
        <div class="row lead-title"><h2>ЛУЧШИЕ КУРСЫ</h2></div>
    </div>
    <div class="arrows">
        <svg version="1.1" id="arrow-slider-left" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 18 57" width="17px" xml:space="preserve">
	<polygon class="st0" points="18,0 18,57 0,28.5 "/>
</svg>
<svg version="1.1" id="arrow-slider-rigth" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     x="0px" y="0px"
     viewBox="0 0 18 57" width="17px" xml:space="preserve">
<polygon class="st0" points="0,0 0,57 18,28.5 "/>
    ...
    <div class="container">
        <div class="row"><a href="courses">
                <div class="button-to-all">Все курсы</div>
            </a></div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="/page/{{$progressPages[4]}}">
                        <div class="icon-text"><p>ПОДАЕТЕ ЗАЯВКУ</p>
                            <p>НА КУРС</p></div>
                    </a>
                </div>
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="/page/{{$progressPages[5]}}">
                        <div class="icon-text"><p>ВЫБИРАЕТЕ</p>
                            <p>ПРОГРАММУ ОБУЧЕНИЯ</p></div>
                    </a>
                </div>
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="">
                        <div class="icon-text"><p>ОЖИДАЕТЕ</p>
                            <p>АКТИВАЦИИ</p></div>
                    </a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-2 hidden-sm hidden-xs arr1"><img src="{{ url('/site_images/arrows3.png') }}"></div>
                <div class="col-md-1 hidden-sm hidden-xs"></div>
            </div>
            <div class="row">
                <div class="col-md-1 hidden-sm hidden-xs"></div>
            ...
            <div class="row">
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="/page/{{$progressPages[7]}}">
                        <div class="icon-text"><p>ПОЛУЧАЕТЕ </p>
                            <p>СЕРТИФИКАТ</p></div>
                    </a>
                </div>
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="/page/{{$progressPages[8]}}">
                        <div class="icon-text"><p>ВЫПОЛНЯЕТЕ</p>
                            <p>ИТОГОВУЮ РАБОТУ</p></div>
                    </a>
                </div>
                <div class="col-md-4 hidden-sm hidden-xs progress-text">
                    <a href="/page/{{$progressPages[9]}}">
                        <div class="icon-text"><p>ОБУЧАЕТЕСЬ ПО</p>
                            <p>ВЫБРАННОЙ ПРОГРАММЕ</p></div>
                    </a>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4  hidden-lg hidden-md progress-text">
                    <a href="/page/{{$progressPages[6]}}">
                        <img src="{{ url('/site_images/icon-pay.png') }}">
                        <div class="icon-text"><p>ОПЛАЧИВАЕТЕ</p>
                            <p>КУРС</p></div>
                    </a>
                </div>
    ...
    <div class="students">
        <div class="arrows">
            <svg version="1.1" id="arrow-student-left" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 18 57" width="17px" xml:space="preserve">
		<polygon class="st0" points="18,0 18,57 0,28.5 "/>
	</svg>
	<svg version="1.1" id="arrow-student-rigth" xmlns="http://www.w3.org/2000/svg"
         xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
         viewBox="0 0 18 57" width="17px" xml:space="preserve">
	<polygon class="st0" points="0,0 0,57 18,28.5 "/>
</svg>
                    ...
                    <div id="student-slider-inside">
                        @foreach($sliderUsers as $sliderUser)
                            <div class="one-student">
                                <div style="background-image: url(/user_logos/{{$sliderUser->logo}});"
                                     class="image-student"></div>
    ...
    <div class="present">
        <div class="container">
            <div class="row">
                <img src="{{ url('/site_images/icon-bookmark.png') }}"><h5>ПРОБНЫЙ УРОК!</h5><img
                        src="{{ url('/site_images/icon-present.png') }}">
